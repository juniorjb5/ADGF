...
* Podríamos usar `method = "difference"`. Obtenemos diferencias absolutas en precios, no retornos.
...
# ¿Qué diferencia hay entre el retorno simple y el logarítmico?


.pull-left[

Suponga que un activo pasa de $(P_{t-1})$ a $(P_t)$.


### Idea clave

- El **retorno simple** mide el cambio porcentual directo.
- El **retorno logarítmico** mide el cambio en escala logarítmica.
- Cuando las variaciones son pequeñas, ambos valores suelen ser muy parecidos.

### Ejemplo

Si el precio pasa de 100 a 110:

- Retorno simple: $(\frac{110-100}{100} = 0.10 = 10\%)$
- Retorno logarítmico: $(\ln(110/100) \approx 0.0953)$
...
### ¿Por qué usar retorno logarítmico?

- Es muy útil en modelación estadística y series de tiempo.
- Tiene una ventaja importante: **se puede sumar en el tiempo**.
...
# ¿Cuántos tipos de retornos hay? ¿Y por qué la diferencia no es un retorno?


.pull-left[

### Tipos de retornos más comunes en finanzas

**1. Retorno simple o discreto**


**2. Retorno logarítmico**

**3. Retorno total**
Incluye precio más dividendos o cupones:

----


> ¿Por qué $(P_t - P_{t-1})$ no se considera un retorno?

Porque eso representa una **diferencia absoluta en precios**, no una variación relativa.
...
- Activo A: pasa de 10 a 12  
  $P_t - P_{t-1} = 2   ;  r_t = 20\%$

- Activo B: pasa de 100 a 102  
  $P_t - P_{t-1} = 2  ;   r_t = 2\%$
...
- La **diferencia** solo indica cuántas unidades subió o bajó el precio.
- Un **retorno financiero** expresa el cambio **en relación con el precio inicial**.
- Por eso, en finanzas, los retornos se trabajan como medidas **relativas**, no solo como restas.
